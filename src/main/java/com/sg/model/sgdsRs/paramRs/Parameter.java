...
public class Parameter {
     ...
     */
    @JsonProperty("AllowedMembers")
    public Object getAllowedMembers() {
     ...
     */
    @JsonProperty("AllowedMembers")
    public void setAllowedMembers(Object allowedMembers) {
     ...
     */
    @JsonProperty("ParameterMappings")
    public void setParameterMappings(Object parameterMappings) {
